...
public class Player_CustomListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MediaPlayer.Player+CustomListener, MediaPlayer", Player_CustomListener.class, __md_methods);
	}


	public Player_CustomListener ()
	{
		super ();
		if (getClass () == Player_CustomListener.class)
			mono.android.TypeManager.Activate ("MediaPlayer.Player+CustomListener, MediaPlayer", "", this, new java.lang.Object[] {  });
	}
